...
| BA-04 | Reconfirm Home-Node Structural Congruence | Update (validation) | Membership | ERB-C007-03 / EX-C007-06 | ⏳ Not started — may collapse into BA-03; confirm at that BA's own gap analysis |
| BA-05 | Govern Membership Standing (Lifecycle Transition) | Update (state transition) | Membership | ERB-C007-04 / EX-C007-07 | ⏳ Not started |
| BA-06 | Reactivate Membership | Update (state transition) | Membership | ERB-C007-04 / EX-C007-08 | ⏳ Not started |
