...
| **Last Updated** | 2026-07-30 (WP-05 Certified — Closed, `CERT-WP-05` PASS WITH OBSERVATIONS) |
...
| Certified Work Packages | 6 (WP-01, WP-02, WP-03, WP-04, WP-05, WP-RTA-001) — WP-01 via two certifications (original + IRA-001A correction) |
| Current Active Work Package | None — no chartered capability Work Package is currently In Progress. WP-05 (C-002, Access Management) is now **CLOSED — Certified** (`CERT-WP-05`, PASS WITH OBSERVATIONS). |
...
| Business Activities In Progress (WP-05) | N/A — WP-05 is closed. 4/4 implemented, independently reviewed and certified (`CERT-WP-05`, 601/601 full AuthService suite passing, zero regressions). |
...
| WP-05 | C-002 | Govern access rights | Business | Closed | 4 (BA-01 scoped to Unresolved/Deferred only; BA-03 scoped to classification portion only) | 4/4 | 2026-07-30 | 2026-07-30 | Fresh-context independent reviewer | `CERT-WP-05` PASS WITH OBSERVATIONS | Not committed | 2026-07-30 | Minimum-scope authorization per `IRA-005 §12`; full BA-01 Permitted/Denied and BA-03's re-resolution path excluded pending a future, separately gap-analyzed `WP-RTA-001` integration (no real `TierResolver` exists yet). 29 new tests (15 unit + 14 API), 601/601 full suite passing. `TD-079`/`TD-080` Open (Low); `TD-081` raised by Independent Review and Closed same-day (missing branch-level API assertions added). |
...
| Capability | N/A |
| Current Status | WP-05 (C-002, Access Management) closed as **Certified** on 2026-07-30 (`CERT-WP-05`, PASS WITH OBSERVATIONS). No successor Work Package has been chartered or accepted an IRA as of this register's Last Updated date. |
| Current BA | None |
| Next Step | Repository-owner decision on which uncharted capability (of the 38 remaining per §8's own audit reference) to charter next, and its own IRA |
| Dependencies | N/A |
...
| WP-05 | 2026-07-30 | 2026-07-30 (`CERT-WP-05`) | Not committed |
...
No Work Package currently has an accepted-but-not-yet-Closed IRA — WP-05 (`IRA-005`) is now Closed/Certified and moved to §7. No future Work Package number is speculatively assigned here.
