...
**Total documents registered above: 46** (14 Architecture + 2 Experience-family entries + 6 Engineering + 2 Design + 17 Governance + 1 Implementation-family entry — see §12 for the exact count reconciliation).
