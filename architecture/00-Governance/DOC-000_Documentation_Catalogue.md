...
| WPR-001 | Work Package Roadmap | Governance | `architecture/00-Governance/WPR-001_Work_Package_Roadmap.md` | Repository Owner / Engineering Governance | Governance Registry (roadmap/definition authority) | Active | N/A (living registry) | 2026-07-31 | Engineering Governance, Implementers |
| WP-REG-001 | Enterprise Work Package Register | Governance | `architecture/00-Governance/WP-REG-001_Enterprise_Work_Package_Register.md` | Repository Owner / Engineering Governance | Governance Registry (execution-status authority) | Active | 1.0 | 2026-07-31 | Executives, Architects, Reviewers |
| DOC-000 | Enterprise Documentation Register (this document) | Governance | `architecture/00-Governance/DOC-000_Documentation_Catalogue.md` | Chief Architecture Office | Governance Registry (document-inventory authority) | Active | 2.0 (evolved from Navigation Guide) | 2026-07-31 | All roles |
...
| TECH-DEBT | Technical Debt Register | Governance | `architecture/06-Reviews/TECH-DEBT.md` | Repository-wide (per-entry ownership) | Governance Registry | Active | N/A (living register, 99 entries) | 2026-07-31 (latest: TD-099, `VV-AUDIT-WP-07` F-01) | All engineering roles |
...
| IRA Reports | Implementation Readiness Assessments (IRA-001, IRA-001A, IRA-002 through IRA-007, IRA-RTA-001) | Governance | `architecture/05-Implementation/IRA-*.md` | Implementing session per WP | Governance (readiness gate) | 9 Accepted | N/A (index of 9 documents) | 2026-07-31 (latest: IRA-007) | Implementers, Reviewers |
| Independent Review / Certification Reports | CERT-WP-01, CERT-WP-01A, CERT-WP-02, CERT-WP-03, CERT-WP-04, CERT-WP-05, CERT-WP-06, CERT-WP-07, CERT-WP-RTA-001 | Governance | `architecture/06-Reviews/CERT-*.md` | Independent (fresh-context) reviewer, per `CLAUDE.md §19.7` | Governance (certification authority) | 9 issued (8 PASS WITH OBSERVATIONS, 1 CERTIFIED WITH CONDITIONS — resolved) — CERT-WP-05's own PASS WITH OBSERVATIONS did not survive a subsequent independent V&V audit (`VV-AUDIT-WP-05`, two `CLAUDE.md §19.8.5`-class defects); both remediated and independently re-verified (`VV-AUDIT-WP-05_Remediation_Verification.md`, CONFIRMED WITH OBSERVATIONS) — WP-05 restored to CLOSED — Certified. CERT-WP-06's own V&V Audit and Release Readiness Audit have both since completed — WP-06 is CLOSED — Certified, committed `a82ff87`. CERT-WP-07 has since been followed by its own V&V Audit (`VV-AUDIT-WP-07`, Gate 2, PASS WITH OBSERVATIONS, no remediation required) — WP-07 remains open pending Gate 5 (Release Readiness Audit) only. | N/A (index of 9 documents) | 2026-07-31 (latest: CERT-WP-07) | Executives, Reviewers, Auditors |
...
| Document ID | Document Name | Category | Repository Path | Owner | Canonical Status | Lifecycle Status | Current Version | Last Updated | Primary Audience |
|---|---|---|---|---|---|---|---|---|---|
| Implementation Reports | IMP-REPORT-WP-01 through WP-07, IMP-REPORT-WP-RTA-001 | Implementation | `architecture/05-Implementation/IMP-REPORT-*.md` | Implementing session per WP | Implementation audit trail (not certification, per `CLAUDE.md §19` Implementation Reporting note) | 8 issued (6 Closed, 1 Certified-conditions-resolved, 1 V&V-Audited-pending-Release-Readiness-Audit) | N/A (index of 8 documents) | 2026-07-31 (latest: IMP-REPORT-WP-07) | Implementers, Reviewers |

**Total documents registered above: 47** (14 Architecture + 2 Experience-family entries + 6 Engineering + 2 Design + 22 Governance + 1 Implementation-family entry — recounted directly against §8's own rows; the WP-06 Release Readiness Audit, `RRA-WP-06`, first reconciled this line to 45/20 Governance, the `RRA-WP-06` row itself brought it to 46/21, and `VV-AUDIT-WP-07`'s own new row (added following `VV-AUDIT-WP-05`/`VV-AUDIT-WP-06`'s own precedent of a dedicated row per V&V Audit, distinct from the family-folded `CERT-WP-*` row) brings it to 47/22 — see §12 for the exact count reconciliation).
...
| TECH-DEBT | Every disclosed, non-blocking implementation gap | `TD-001`–`TD-099` |
...
| Statistic | Value |
|---|---|
| Total Documents Registered | 47 (per §8's own count, including grouped family entries; 46 as of `RRA-WP-06`'s own recount, +1 for `VV-AUDIT-WP-07`'s own new row, added following the same per-V&V-Audit-row precedent `VV-AUDIT-WP-05`/`VV-AUDIT-WP-06` already established) |
...
| Implementation Documents (family entry; 8 individual reports beneath it) | 1 family entry (8 individual reports, including `IMP-REPORT-WP-07`) |
| Active Documents (Status: Active/AUTHORITATIVE/RELEASED/LOCKED, currently governing) | Not re-derived this pass; denominator is 47. The numerator was already left undetermined by `RRA-WP-06`'s own recount (at 45) and is not guessed forward here for the two further documents (`RRA-WP-06`, `VV-AUDIT-WP-07`) added since — this remains an arithmetic reconciliation, not a full content/canonical-status review |
