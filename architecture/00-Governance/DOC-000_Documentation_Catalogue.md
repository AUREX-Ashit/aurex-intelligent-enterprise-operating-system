...
| TECH-DEBT | Technical Debt Register | Governance | `architecture/06-Reviews/TECH-DEBT.md` | Repository-wide (per-entry ownership) | Governance Registry | Active | N/A (living register, 104 entries) | 2026-08-01 (latest: TD-104, `CERT-WP-08`/`VV-AUDIT-WP-08`) | All engineering roles |
...
| IRA Reports | Implementation Readiness Assessments (IRA-001, IRA-001A, IRA-002 through IRA-008, IRA-RTA-001) | Governance | `architecture/05-Implementation/IRA-*.md` | Implementing session per WP | Governance (readiness gate) | 10 Accepted | N/A (index of 10 documents) | 2026-07-31 (latest: IRA-008) | Implementers, Reviewers |
| Independent Review / Certification Reports | CERT-WP-01, CERT-WP-01A, CERT-WP-02, CERT-WP-03, CERT-WP-04, CERT-WP-05, CERT-WP-06, CERT-WP-07, CERT-WP-08, CERT-WP-RTA-001 | Governance | `architecture/06-Reviews/CERT-*.md` | Independent (fresh-context) reviewer, per `CLAUDE.md §19.7` | Governance (certification authority) | 10 issued (9 PASS WITH OBSERVATIONS, 1 CERTIFIED WITH CONDITIONS — resolved) — CERT-WP-05's own PASS WITH OBSERVATIONS did not survive a subsequent independent V&V audit (`VV-AUDIT-WP-05`, two `CLAUDE.md §19.8.5`-class defects); both remediated and independently re-verified (`VV-AUDIT-WP-05_Remediation_Verification.md`, CONFIRMED WITH OBSERVATIONS) — WP-05 restored to CLOSED — Certified. CERT-WP-06's own V&V Audit and Release Readiness Audit have both since completed — WP-06 is CLOSED — Certified, committed `a82ff87`. CERT-WP-07 has since been followed by its own V&V Audit (`VV-AUDIT-WP-07`) and Release Readiness Audit (`RRA-WP-07`) — WP-07 is CLOSED — Certified, committed `6da647e`. CERT-WP-08 (first Work Package under `CLAUDE.md §20`) has since been followed by its own V&V Audit (`VV-AUDIT-WP-08`) and Release Readiness Audit (`RRA-WP-08`) — WP-08 is CLOSED — Certified, committed `808c06d`. | N/A (index of 10 documents) | 2026-08-01 (latest: CERT-WP-08) | Executives, Reviewers, Auditors |
...
| Document ID | Document Name | Category | Repository Path | Owner | Canonical Status | Lifecycle Status | Current Version | Last Updated | Primary Audience |
|---|---|---|---|---|---|---|---|---|---|
| Implementation Reports | IMP-REPORT-WP-01 through WP-08, IMP-REPORT-WP-RTA-001 | Implementation | `architecture/05-Implementation/IMP-REPORT-*.md` | Implementing session per WP | Implementation audit trail (not certification, per `CLAUDE.md §19` Implementation Reporting note) | 9 issued (8 Closed, 1 Certified-conditions-resolved) | N/A (index of 9 documents) | 2026-08-01 (latest: WP-08 CLOSED, committed `808c06d`) | Implementers, Reviewers |
...
**Total documents registered above: 55** (14 Architecture + 2 Experience-family entries + 6 Engineering + 2 Design + 28 Governance + 3 Implementation entries [the WP-01…08/RTA-001 family row, `IMP-REPORT-RELEASE-A1`, and `IMP-REPORT-RELEASE-A2`] — recounted directly against §8's own rows; the WP-06 Release Readiness Audit, `RRA-WP-06`, first reconciled this line to 45/20 Governance, the `RRA-WP-06` row itself brought it to 46/21, `VV-AUDIT-WP-07`'s own new row brought it to 47/22, `VV-AUDIT-WP-08`'s own new row (added following `VV-AUDIT-WP-05`/`06`/`07`'s own precedent of a dedicated row per V&V Audit, distinct from the family-folded `CERT-WP-*` row) brought it to 48/23, `RRA-WP-08`'s own Gate 5 review found `RRA-WP-07`'s own row had never been added (a pre-existing omission, not introduced by that pass) — adding it (49/24) and its own `RRA-WP-08` row (50/25) brought the total to 50/25, `PRODUCT-MILESTONE-ROADMAP` (51/26) was added per a separate repository-owner instruction to register that document as a canonical planning artifact, `IMP-REPORT-RELEASE-A1` (52/26 Governance, 2 Implementation) was added per Release A1's own Governance Synchronization phase, `RELEASE-A2-AI-CONFIGURATION-GOVERNANCE-REVIEW` (53/27) was added as a Governance-category advisory review artifact, `AI-CONFIGURATION-TRACEABILITY-MATRIX` (54/28) was added per that validation's own output instruction, and this pass adds `IMP-REPORT-RELEASE-A2` as a third, distinct Implementation-category entry (55/28 Governance, 3 Implementation) per Release A2's own closure — see §12 for the exact count reconciliation).
...
| Implementation Documents (3 entries: the WP-01…08/RTA-001 family row [9 individual reports beneath it], `IMP-REPORT-RELEASE-A1`, and `IMP-REPORT-RELEASE-A2`) | 3 entries (11 individual reports total) |
| Active Documents (Status: Active/AUTHORITATIVE/RELEASED/LOCKED, currently governing) | Not re-derived this pass; denominator is 50. The numerator was already left undetermined by `RRA-WP-06`'s own recount (at 45) and is not guessed forward here for the further documents (`RRA-WP-06`, `VV-AUDIT-WP-07`, `RRA-WP-07`, `VV-AUDIT-WP-08`, `RRA-WP-08`) added since — this remains an arithmetic reconciliation, not a full content/canonical-status review |
