...
| Session governance (Conversation/Interaction lifecycle, continuity, cross-lifecycle handoff) | RTA-001 §13.15a (AI Session Management) | **Owned — added per `ADR-020`**, Repository Owner Constitutional Design Workshop, 2026-08-07. Session governance is distinct from, and does not touch, Memory governance below — Conversation Continuity is explicitly defined as never depending on Enterprise Memory. |
| Experience governance (AI-Native Enterprise Experience composition, accountability boundary, capability-layer adoption) | SD-001 §16 (AI-Native Enterprise Experience Framework) | **Owned — added per `ADR-021`**, Repository Owner Constitutional Design Workshop, 2026-08-07. Experience governance is a Presentation-layer concern (parallel to, never nested inside, Runtime per this document's own §8 dependency model) and introduces no new Layer 1 concern; it composes existing SD-001 contracts and RTA-001 §13.15a without redefining either. |
