...
class TenantHeaderMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request: Request, call_next):
        ...
        # "/search" (WP-11, IRA-011 §5) and "/conversations" (WP-12, IRA-012 §5)
        # are also excluded: their own endpoints derive organization_id from a
        # real, verified JWT claim (dependencies.get_current_claims) — the raw,
        ...
        # unaffected.
        bypass_paths = ["/docs", "/openapi.json", "/redoc", "/ai/health", "/search", "/conversations"]
